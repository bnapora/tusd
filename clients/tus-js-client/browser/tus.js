(function (global, factory) {
    ...
    class BaseUpload {
        ...
        async _startParallelUpload() {
            ...
            const partsBoundaries = (_a = this.options.parallelUploadBoundaries) !== null && _a !== undefined ? _a : splitSizeIntoParts(this._size, partCount);
            // Attach URLs from previous uploads, if available.
            const parts = partsBoundaries.map((part, index) => {
                var _a;
                return ({
                    ...part,
                    uploadUrl: ((_a = this._parallelUploadUrls) === null || _a === undefined ? undefined : _a[index]) || null,
                });
            });
        ...
        async _addChunkToRequest(req) {
            ...
            const sizeOfValue = size !== null && size !== undefined ? size : 0;
